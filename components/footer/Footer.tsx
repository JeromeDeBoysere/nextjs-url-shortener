	...
	return (
		<footer className="bg-gray-100 border-t border-gray-200">
			<div className="max-w-4xl mx-auto px-4 py-6">
				{/* Top section: Project info and social links */}
				<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
					<div>
						<h3 className="font-semibold text-gray-900">URL Shortener</h3>
						<p className="text-sm text-gray-600 max-w-md">
							Application de raccourcissement d&apos;URLs construite avec Next.js 15, Prisma et Supabase.
						</p>
					</div>
				...
				{/* Bottom section: Copyright and database status */}
				<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 pt-4 border-t border-gray-200">
					<p className="text-sm text-gray-500">&copy; {new Date().getFullYear()} URL Shortener</p>
					<DatabaseStatus />
				</div>
			</div>
		</footer>
